...
export default function AttendanceTable({ canMark, canNotify, entities, mode, records, selectedDate, onMark, onNotify }) {
  return (
      ...
      <table className="w-full text-sm border-separate border-spacing-y-2">
        ...
        <tbody>
          {entities.map((entity) => {
            ...
            return (
              <tr key={entity.id} className="bg-white shadow-[0_0_0_1px_rgba(226,232,240,0.9)] rounded-lg">
                ...
                <td className="px-5 py-4"><StatusBadge value={record?.status || 'Not Marked'} /></td>
